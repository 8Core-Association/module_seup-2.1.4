        ...
        <div class="seup-grid seup-grid-2">
            <div class="seup-card" style="border: 1px solid var(--seup-gray-200);">
                ...
                <div class="seup-card-body">
                    ...
                    <div class="seup-form-group">
                        <label for="klasa_br" class="seup-label">{$langs->trans("Klasabroj")}</label>
                    ...
                    <div class="seup-form-group">
                        ...
                        <select name="sadrzaj" id="sadrzaj" class="seup-select" data-placeholder="{$langs->trans("OdaberiSadrzaj")}">
                            <option value="">{$langs->trans("OdaberiSadrzaj")}</option>
                        </select>
                    </div>

                    <div class="seup-form-group">
                        <label for="dosjeBroj" class="seup-label">{$langs->trans("DosjeBroj")}</label>
                        <select name="dosjeBroj" id="dosjeBroj" class="seup-select" data-placeholder="{$langs->trans("OdaberiDosjeBroj")}">
                            <option value="">{$langs->trans("OdaberiDosjeBroj")}</option>
                        </select>
                    </div>
...
<script type="text/javascript">
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    const placeholderText = "<?php echo $langs->trans('OdaberiSadrzaj'); ?>";
